...
<template>
    <div :theme="theme" ref="loadingContainerNew" class="loading overflow-hidden p-0  z-15 w-full h-[100dvh] bg-primary fill-foreground fixed top-0 left-0 flex text-white justify-center items-center ">
