...
export default {
  ...
  methods: {
    ...
    animateEnd(iter = 0) {
        ...
        const loading = this.$refs.loadingContainerNew;
        const d = this.$refs.d;
        const p = this.$refs.p;
        const a = this.$refs.a;
        const c = this.$refs.c;
...
<template>
    <div :theme="theme" ref="loadingContainerNew" class="loading overflow-hidden p-0 scale-130 md:scale-100 z-15 w-full h-[100dvh] bg-primary fill-foreground fixed top-0 left-0 flex text-white justify-center items-center ">
